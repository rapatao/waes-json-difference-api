...
public class DiffControllerTest {
    ...
    public void shouldAddBothSidesAndGetEquals() throws Exception {
        ...
        mvc.perform(MockMvcRequestBuilders
                ...
                .contentType(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk())
                .andExpect(content().string(containsString("EQUALS")));
    }

    @Test
    public void shouldAddBothSidesWithDifferentSizesAndGetTheResultAsDifferentSize() {
        throw new RuntimeException();
    }

    @Test
    public void shouldAddBothSidesWithSameSizeAndGetTheResultAsDifferentContent() {
        throw new RuntimeException();
    }

    @Test
    public void shouldAddOneSideAndGotErrorWhenGetDiff() {
        throw new RuntimeException();
    }

    @Test
    public void shouldGetNotFoundWhenGetDiffFromInvalidIdentifier() {
        throw new RuntimeException();
    }
